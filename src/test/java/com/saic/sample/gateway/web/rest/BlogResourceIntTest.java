...
import com.saic.sample.gateway.domain.Blog;
import com.saic.sample.gateway.repository.BlogRepository;
import com.saic.sample.gateway.service.BlogService;
import com.saic.sample.gateway.service.dto.BlogDTO;
import com.saic.sample.gateway.service.mapper.BlogMapper;
...
import static com.saic.sample.gateway.web.rest.TestUtil.createFormattingConversionService;
...
public class BlogResourceIntTest {
    ...
    public void createBlog() throws Exception {
        ...
        assertThat(testBlog.getUser()).isEqualTo(DEFAULT_USER);
    }
    ...
    public void updateBlog() throws Exception {
        ...
        assertThat(testBlog.getUser()).isEqualTo(UPDATED_USER);
    }
