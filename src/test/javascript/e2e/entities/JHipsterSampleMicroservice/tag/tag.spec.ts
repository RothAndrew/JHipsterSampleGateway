...
describe('Tag e2e test', () => {
    ...
    it('should load Tags', () => {
        ...
        expect(tagComponentsPage.getTitle()).toMatch(/jHipsterSampleGatewayApp.jHipsterSampleMicroserviceTag.home.title/);
    });

    it('should load create Tag page', () => {
        tagComponentsPage.clickOnCreateButton();
        tagUpdatePage = new TagUpdatePage();
        expect(tagUpdatePage.getPageTitle()).toMatch(/jHipsterSampleGatewayApp.jHipsterSampleMicroserviceTag.home.createOrEditLabel/);
