...
describe('Entry e2e test', () => {
    ...
    it('should load Entries', () => {
        ...
        expect(entryComponentsPage.getTitle()).toMatch(/jHipsterSampleGatewayApp.jHipsterSampleMicroserviceEntry.home.title/);
    });

    it('should load create Entry page', () => {
        entryComponentsPage.clickOnCreateButton();
        entryUpdatePage = new EntryUpdatePage();
        expect(entryUpdatePage.getPageTitle()).toMatch(/jHipsterSampleGatewayApp.jHipsterSampleMicroserviceEntry.home.createOrEditLabel/);
