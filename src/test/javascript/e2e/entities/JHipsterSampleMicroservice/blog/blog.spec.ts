...
describe('Blog e2e test', () => {
    ...
    it('should load Blogs', () => {
        ...
        expect(blogComponentsPage.getTitle()).toMatch(/jHipsterSampleGatewayApp.jHipsterSampleMicroserviceBlog.home.title/);
    });

    it('should load create Blog page', () => {
        blogComponentsPage.clickOnCreateButton();
        blogUpdatePage = new BlogUpdatePage();
        expect(blogUpdatePage.getPageTitle()).toMatch(/jHipsterSampleGatewayApp.jHipsterSampleMicroserviceBlog.home.createOrEditLabel/);
