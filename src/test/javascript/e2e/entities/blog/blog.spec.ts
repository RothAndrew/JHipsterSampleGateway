...
describe('Blog e2e test', () => {
    ...
    it('should load Blogs', () => {
        ...
        expect(blogComponentsPage.getTitle()).toMatch(/jHipsterSampleGatewayApp.blog.home.title/);
    });

    it('should load create Blog page', () => {
        blogComponentsPage.clickOnCreateButton();
        blogUpdatePage = new BlogUpdatePage();
        expect(blogUpdatePage.getPageTitle()).toMatch(/jHipsterSampleGatewayApp.blog.home.createOrEditLabel/);
    ...
    it('should create and save Blogs', () => {
        ...
        blogUpdatePage.setUserInput('5');
        expect(blogUpdatePage.getUserInput()).toMatch('5');
